...
#define COPYBIT_SKIP_SMALL_HWBLIT       1
...
enum {
    ...
    COPYBIT_FORMAT_YCrCb_NV12   = HAL_PIXEL_FORMAT_YCrCb_NV12,
...
enum {
     ...
     * at this time. */
    COPYBIT_BLUR            = 5,
    COPYBIT_LayerCount      = 6,
    COPYBIT_QUERY_POWERSTATE  = 7,
    /* enable or disable scale using filter */
    COPYBIT_FILTER_SCALE    = 8,
    COPYBIT_ASYNC           = 9
};
...
enum {
    ...
    /* */
    COPYBIT_FRAMEBUFF_16BITS_FLAG   = 5,
};
...
struct copybit_device_t {
    ...
    int (*stretch_normal)(struct copybit_device_t *dev,
                    struct copybit_image_t const *dst,
                    struct copybit_image_t const *src, 
                    struct copybit_rect_t const *dst_rect,
                    struct copybit_rect_t const *src_rect);
     ...
     * @return 0 if successful
     */               
    int (*sync_engine) (struct copybit_device_t *dev);                  
};
