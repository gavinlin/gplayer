...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --cross-prefix=arm-linux-androideabi- --arch=arm --cpu=armv7-a --sysroot=/home/gavinlin/bin/android-ndk-r7//platforms/android-14/arch-arm --disable-avdevice --disable-static --enable-shared --disable-ffplay --disable-doc --disable-ffmpeg --disable-ffprobe --disable-ffserver --disable-avfilter --disable-encoders --disable-muxers --disable-filters --disable-devices --enable-version3 --enable-asm --enable-neon --extra-cflags='-I/home/gavinlin/bin/android-ndk-r7//sources/cxx-stl/system/include -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16' --extra-ldflags='-Wl,--fix-cortex-a8' --extra-cxxflags='-Wno-multichar -fno-exceptions -fno-rtti'
prefix=/usr/local
...
CPPFLAGS= --sysroot=/home/gavinlin/bin/android-ndk-r7//platforms/android-14/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
CFLAGS= -I/home/gavinlin/bin/android-ndk-r7//sources/cxx-stl/system/include -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
CXXFLAGS= -Wno-multichar -fno-exceptions -fno-rtti -D__STDC_CONSTANT_MACROS
ASFLAGS= -I/home/gavinlin/bin/android-ndk-r7//sources/cxx-stl/system/include -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -march=armv7-a -fPIC -g
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -Wl,--fix-cortex-a8 --sysroot=/home/gavinlin/bin/android-ndk-r7//platforms/android-14/arch-arm -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
